---
title: "Aggregates - From Elections Book"
author: ""
...
We're going to establish a pattern that will come up again and again throughout this book:
...
`summarize(VARIABLE NAME = AGGREGATE FUNCTION(COLUMN NAME))`
